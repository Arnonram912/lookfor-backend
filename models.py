...
class Item(Base):
    ...
    report_owner_user_id = Column(Integer, nullable=True, index=True)
    report_owner_name = Column(String(255), nullable=True)
    report_owner_group = Column(String(100), nullable=True)
